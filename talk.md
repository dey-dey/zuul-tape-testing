...
### Borne of years of frustration

---
# Tape by substack

A tap-producing test harness for node and browsers. TAP is a standard for test output.
...
###### From `Maintainable Javascript` by Zakas
---
